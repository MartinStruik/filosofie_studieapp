...
const QUIZ_QUESTIONS = [
  ...
  { q: "Waarom behouden mensen volgens Hayles morele verantwoordelijkheid in cognitieve assemblages?", options: ["Omdat mensen slimmer zijn dan machines", "Omdat mensen kwetsbaar zijn: ze kunnen lijden en sterven", "Omdat alleen mensen kunnen rekenen en redeneren", "Omdat machines geen cognitieve taken kunnen uitvoeren"], correct: 1, explanation: "Hayles benadrukt kwetsbaarheid: mensen kunnen lijden, sterven en verantwoordelijk gehouden worden. Dit maakt hen niet inwisselbaar met machines, ook al delen ze cognitieve taken.", kwestie: 4 },
  ...
  { q: "Despret bekritiseert het derdepersoonsperspectief in dieronderzoek omdat:", options: ["Onderzoekers dan niet objectief genoeg zijn", "Afstand nemen van het dier juist leidt tot vertekening van dierlijk gedrag", "Het derdepersoonsperspectief alleen bij mensen werkt", "Dieren geen perspectief hebben"], correct: 1, explanation: "Despret stelt dat wetenschappers die dieren bestuderen als objectieve buitenstaanders, hun onderwerp vervormen. Door afstand te nemen mis je de essentie van dierlijk gedrag. Beter: een relatie aangaan.", kwestie: 4 },
  { q: "Latours begrip 'delegatie' betekent:", options: ["Dat wetenschappers taken delegeren aan assistenten", "Het overdragen van een moreel programma aan een niet-menselijk object", "Dat de overheid verantwoordelijkheid delegeert aan burgers", "Het verdelen van cognitieve taken over mens en machine (Hayles)"], correct: 1, explanation: "Delegatie (Latour): een moreel gebod wordt overgedragen aan een ding. Bv. een verkeersdrempel dwingt je langzaam te rijden — het 'langzaam rijden' is gedelegeerd aan het object.", kwestie: 4 },
