...
const QUIZ_QUESTIONS = [
  ...
  { q: "Popper stelt dat een theorie wetenschappelijk is als ze:", options: ["In principe weerlegbaar (falsifieerbaar) is", "Empirisch geverifieerd kan worden", "Door de wetenschappelijke gemeenschap wordt geaccepteerd", "Gebaseerd is op inductieve waarnemingen"], correct: 0, explanation: "Falsifieerbaarheid is Poppers demarcatiecriterium: een theorie is pas wetenschappelijk als je kunt aangeven welke waarneming haar zou weerleggen. Verificatie is nooit definitief.", kwestie: 0 },
