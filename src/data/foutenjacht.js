...
export const FOUTENJACHT_ITEMS = [
  ...
  // ====================================================================
  {
    ...
    casus: "De Hubot Opa is een zorgrobot met camera's als ogen. De examentekst vraagt of deze robot op dezelfde manier kan waarnemen als een mens — met verwijzing naar Dreyfus' drie functies van het lichaam bij waarneming.",
    naam: "Tim",
    punten: 3,
  ...
  // ====================================================================
  {
    ...
    casus: "Het examen 2024 TV1 gaat over Jake, een visueel beperkte persoon die prothese-technologie gebruikt. Bij deze vraag wordt een tekst van Tim Morton behandeld over de vraag of planten als actoren beschouwd moeten worden.",
    naam: "Jamal",
    punten: 3,
  ...
  // ====================================================================
  {
    ...
    casus: "In het examen over Jake wordt de echoscopie als voorbeeld van technologische bemiddeling besproken. De vraag gaat over Verbeeks theorie: hoe beïnvloedt technologie zowel onze morele visie als ons morele handelen?",
    naam: "Noor",
    punten: 3,
  ...
  // ====================================================================
  {
    ...
    casus: "Bij deze vraag wordt een tekst van Vinciane Despret behandeld over dieronderzoek. Despret bekritiseert de traditionele wetenschappelijke methode waarbij de onderzoeker zich onzichtbaar maakt voor het dier.",
    naam: "Emma",
    punten: 3,
  ...
  // ====================================================================
  {
    ...
    casus: "Het examen 2024 TV2 behandelt het thema zelfkennis en technologie. Bij de openingsvraag wordt een tekst van Vroon & Draaisma besproken over hoe we metaforen uit wetenschap en technologie gebruiken om onszelf te begrijpen.",
    naam: "Mila",
    punten: 2,
  ...
  // ====================================================================
  {
    ...
    casus: "De examentekst beschrijft hoe bedrijven als Google en Amazon via algoritmes patronen in ons gedrag herkennen. De vraag gaat over Harari's concept van dataïsme: de stelling dat algoritmes ons beter kennen dan wijzelf.",
    naam: "Bram",
    punten: 3,
  ...
  // ====================================================================
  {
    ...
    casus: "Het examen 2025 TV2 behandelt de toekomst van de mens en technologie. Bij deze vraag wordt het personage Iron Man (Tony Stark) als casus gebruikt: iemand die zichzelf met technologie verbetert. De vraag koppelt dit aan Jos de Muls drie toekomstscenario's.",
    naam: "Sem",
    punten: 4,
  ...
  // ====================================================================
  {
    ...
    casus: "De examentekst beschrijft Harari's visie op de toekomst: van humanisme via techno-humanisme naar dataïsme. De vraag richt zich op het onderscheid tussen de laatste twee — een ontwikkeling, geen tegenstelling.",
    naam: "Daan",
    punten: 3,
  ...
  // ====================================================================
  {
    ...
    casus: "De examentekst gaat over kunstmatige intelligentie en bias. De casus beschrijft een gezichtsherkenningssysteem dat mensen met een donkere huidskleur slechter herkent — een praktijkvoorbeeld dat gekoppeld moet worden aan de theorie van het connectionisme.",
    naam: "Roos",
    punten: 3,
  ...
  // ====================================================================
  {
    ...
    kwestie: 1,
    bron: "CE-stijl, gebaseerd op examenbesprekingen 2024–2025",
    casus: "Fanon beschrijft de ervaring van een zwarte man die op straat wordt aangesproken ('Kijk, een neger!'). Deze scène illustreert hoe het raciaal-epidermaal schema het gewone lichaamsschema overschrijft.",
    naam: "Lisa",
    punten: 4,
  ...
  // ====================================================================
  {
    ...
    casus: "De examentekst bespreekt de computermetafoor: het brein als informatieverwerkende machine. De vraag richt zich op het punt waar deze metafoor tekortschiet — specifiek over hoe neuronen werken, niet over het brein in het algemeen.",
    naam: "Max",
    punten: 3,
