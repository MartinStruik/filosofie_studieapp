...
export const FOUTENJACHT_ITEMS = [
  ...
  // ====================================================================
  {
    ...
    opties: [
      { label: "Het antwoord verwijst niet naar tekst 2", correct: false },
      { label: "Het antwoord noemt geen van de twee gevraagde functies van het lichaam, maar herhaalt alleen 'geen menselijk lichaam' — terwijl de hubot wél een lichaam heeft", correct: true },
  ...
  // ====================================================================
  {
    ...
    opties: [
      ...
      { label: "Het antwoord vervangt Mortons filosofische argument door een wetenschappelijk-biologisch argument (plantenneurobiologie) — maar dat is niet wat de vraag of Morton vraagt", correct: true },
      { label: "Het antwoord bevat een feitelijke fout over schimmelnetwerken", correct: false },
  ...
  // ====================================================================
  {
    ...
    opties: [
      { label: "Het antwoord noemt het verkeerde voorbeeld (echoscopie ipv Thwaites)", correct: false },
      { label: "Het antwoord verwart 'nieuwe morele dilemma's' met 'verandering van het moreel handelingsvermogen' — dat zijn niet hetzelfde, en het tweede deel van de vraag (Thwaites) is overgeslagen", correct: true },
  ...
  // ====================================================================
  {
    ...
    opties: [
      ...
      { label: "Het antwoord beargumenteert maar legt niet uit wáárom onzichtbaarheid volgens Despret tot verkeerde conclusies leidt — alleen dát een relatie nuttig is", correct: true },
      { label: "Het antwoord bevat een begripsverwarring", correct: false },
      { label: "Het antwoord mist een tekstverwijzing", correct: false },
    ],
  ...
  // ====================================================================
  {
    ...
    foutType: "vraag_niet_gelezen",
    opties: [
      { label: "Het antwoord is te vaag en herhaalt zichzelf", correct: false },
      ...
      { label: "Het antwoord bevat een begripsverwarring tussen contingent en noodzakelijk", correct: false },
      { label: "Het antwoord verwijst niet naar tekst 1", correct: false },
    ],
  ...
  // ====================================================================
  {
    ...
    foutType: "vraag_niet_gelezen",
    opties: [
      { label: "Het antwoord verwart Plessner met Fanon", correct: false },
      ...
      { label: "Het antwoord is feitelijk onjuist over excentrische positionaliteit", correct: false },
      { label: "Het antwoord verwijst niet naar de bron", correct: false },
    ],
  ...
  // ====================================================================
  {
    ...
    foutType: "begripsverwarring",
    opties: [
      { label: "Het antwoord verwart 'extended' met 'embedded' — een hulpmiddel dat ondersteunt is nog geen extended cognition; daarvoor moet de techniek een integraal onderdeel van het cognitieve proces zijn", correct: true },
      { label: "Het antwoord noemt het verkeerde voorbeeld", correct: false },
      { label: "Het antwoord verwart 'enactive' met 'embodied'", correct: false },
      { label: "Het antwoord verwijst niet naar tekst 4", correct: false },
    ],
  ...
  // ====================================================================
  {
    ...
    foutType: "begripsverwarring",
    opties: [
      { label: "Het antwoord verwart res cogitans met res extensa", correct: false },
      { label: "Het antwoord koppelt res cogitans aan het eerstepersoonsperspectief — maar volgens de syllabus hoort res cogitans juist bij het derdepersoonsperspectief (objectieve beschrijving van een essentiële eigenschap)", correct: true },
      { label: "Het antwoord noemt de verkeerde filosoof voor het cogito", correct: false },
  ...
  // ====================================================================
  {
    ...
    opties: [
      ...
      { label: "Het antwoord beschrijft wat dataïsme IS maar geeft niet het gevraagde argument; bovendien blijft het begrip 'bestaanservaring' helemaal liggen", correct: true },
  ...
  // ====================================================================
  {
    ...
    foutType: "te_vaag",
    opties: [
      { label: "Het antwoord verwart de scenario's", correct: false },
      { label: "Het antwoord noemt geen specifieke namen voor de scenario's (alienscenario, zwermgeestscenario), en 'verbetering' wordt alleen als 'meer kunnen' opgevat zonder de keerzijde te bespreken", correct: true },
      { label: "Het antwoord mist een tekstverwijzing", correct: false },
  ...
  // ====================================================================
  {
    ...
    opties: [
      { label: "Het antwoord noemt de verkeerde filosoof", correct: false },
      { label: "Het antwoord mist de dubbelheid: excentrische positionaliteit is tegelijk centrisch ÉN excentrisch zijn — niet alleen 'van buitenaf bekijken'", correct: true },
  ...
  // ====================================================================
  {
    ...
    foutType: "voorbeeld_ipv_uitleg",
    opties: [
      { label: "Het antwoord geeft Fanons ervaring (de scène op straat) als voorbeeld maar legt het begrip niet algemeen uit", correct: true },
  ...
  // ====================================================================
  {
    ...
    foutType: "strategie",
    opties: [
      { label: "Het antwoord is te vaag — er ontbreekt filosofische taal", correct: false },
      { label: "Het antwoord verspilt 8 minuten op een 1p-vraag waarvan vrijwel niemand het juiste antwoord weet — de juiste strategie is kort opschrijven wat je weet en doorgaan", correct: true },
      { label: "Het antwoord verwart hermeneutiek met fenomenologie", correct: false },
      { label: "Het antwoord mist een tekstverwijzing", correct: false },
    ],
